...
export default function ViewProjects() {
  ...
  const {
    ...
    queryKey: ["projectsData", clientId, dateFilter, query], // use clientId instead of locationId
    queryFn: async ({ pageParam = 1 }) => {
      try {
        const params = new URLSearchParams();
        if (clientId) params.append("id", clientId); // use clientId here
        if (dateFilter) params.append("date_filter", dateFilter);
  ...
  return (
    <div className='px-2 py-3 mt-5'>
      <div className='position-relative'>
        <div className='d-flex justify-content-between align-items-center mb-3'>
          <h5 className='fw-bold mb-0'>
            {filteredProjects[0]?.client_name || "NA"} Client
          </h5>
      ...
      <div className='row'>
        ...
        <div className=' d-flex justify-content-between align-items-center pb-2 pt-1  px-1 pe-3'>
