      ...
      <div className='card shadow-sm border-0 h-100'>
        <div className='card-body d-flex flex-column'>
          <div className='d-flex flex-column gap-1'>
            ...
            <small className={`d-flex align-items-center mute-font`}>
...
export default function TeamsDashboard() {
  ...
  const {
    ...
    queryKey: ["teamsData", locationId, dateFilter, query],
    ...
    <div className='px-2 py-3 mt-5'>
      <div className='position-relative'>
        <div className='d-flex justify-content-between align-items-center mb-3'>
          <h5 className='fw-bold mb-0'>Teams Dashboard</h5>
      ...
      <div className='row mb-4'>
        ...
        <div className=' d-flex justify-content-between align-items-center mt-1'>
          <h5
            className='fw-bold  text-center ms-3 '
