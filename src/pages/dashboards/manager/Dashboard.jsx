...
const Dashboard = () => {
  ...
  const { data: qualityData, isLoading: isQualityLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      if (dashboardTeamId) params.append("team_id", dashboardTeamId);
      if (dateFilter) params.append("date_filter", dateFilter);
      ///api/dashboard/get-quality?date_filter=2&team_id=2&project_id=2&location_id=1
  ...
  //   Chennai: "/images/superadmin-dashboard/Chennai 1.svg",
  //   Thirunelveli: " /images/superadmin-dashboard/Tuticorin 1.svg",
  //   Thanjavur: "  /images/superadmin-dashboard/Tirunelveli 1.svg",
  //   // Thoothukudi: " /images/superadmin-dashboard/Tanjore 1.svg",
  // };

  // const defaultImage = {
  //   overall: "/images/superadmin-dashboard/tamilnadu-map.svg",
  // };
          ...
          <div className="row g-3">
            ...
            <div className="col-lg-6">
              <div className="row g-3">
                    ...
                    <div className="card-body py-2 px-0">
                      ...
                      <div className="d-flex mx-2 gap-3">
                        <Link
                          ...
                          style={{ textDecoration: "none" }}
                        >
                          <div className="card bg-adminusers  lightcard  w-132 align-items-center ">
                        ...
                        <div className="card bg-adminusers  lightcard w-500 ">
                      ...
                      <div className="h-100 d-flex justify-content-center">
                        {locationId === null ? (
                          <div className="w-300 mx-auto text-center ">
                            <img
                              src={defaultImage.overall}
                              alt="Overall"
                              className="tamilnadu-map"
                            />
                          </div>
                        ) : (
                          listLocation?.data.map((location) => {
                            if (locationId !== location.id) return null;

                            const imageSrc = districtImages[location.district]
                              ? districtImages[location.district]
                              : defaultImage.overall;

                            return (
                              <div
                                key={location.id}
                                className="w-300 mx-auto text-center mt-2"
                              >
                                <img
                                  src={imageSrc}
                        ...
                        <div className="mt-100 mx-auto">
                          {locationId === null
                            ? Object.entries(highlightedDistricts).map(
                                ([district, color]) => (
                                  <div
                                    key={district}
                                  ...
                                  >
                                    <span
                                      className="rounded-circle me-2 districat-size"
                            ...
                            : listLocation?.data
                                ...
                                .map((location) => {
                                  const color =
                                    highlightedDistricts[location.district] ||
                                    "#D1D5DB";
                                  return (
                                    <div
                ...
                {/* <div className='col-12 col-sm-12 col-md-12 col-lg-12'>
              <div className='card  darkcard card-450'>
                <div className='card-body'>
                  <div className='w-100 w-md-50 d-flex flex-column gap-3'>
                    <h5 className=' d-flex align-items-center fw-semibold fs-base lh-base text-nowrap customguide-background'>
                      <img
                        src='/images/superadmin-dashboard/location-icon.svg'
                        className='mr-2 me-2 icon-size'
                        alt='Location Icon'
                      />
                      User classification
                    </h5>
                ...
                <div className="card-header header-skyblue">
                  <h2 className="h6 mb-0">
                    ...
                    {/* <FaAward
                      icon="fa-solid fa-award"
                      size={14}
                      className="mr-2 perform-icon icon-size-rank me-2 emoji-image"
                    /> */}
