        ...
        <div className=" timeframetable-body">
          <div style={{ width: "250px" }}>
            ...
            <div className="timeframetable-subheader">
              <span className="mx-auto">Charts</span>
              <span className="mx-auto">ICD</span>
        ...
        return (
          <div style={{ width: "120px" }}>
            <button className="cus-count text-center ms-4 pe-none">
              {row.original.total_chart_count ?? "NA"}
            </button>
          </div>
        );
      },
        ...
        <>
          {row.original.total_chart_count !== 0 ? (
            ...
            >
              <button>
                <Link
                  to={`/coder/charts/${row.original.user_log_id}`}
                  state={{
                    rows: row.original,
                    memberType: "teams_summary_coder",
                  }}
                >
...
export default CoderTabColumns;
