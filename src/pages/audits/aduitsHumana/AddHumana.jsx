...
const AddHumana = ({ projectID }) => {
  ...
  const [selectedAuditMode, setSelectedAuditMode] = useState("");
  ...
  if (project_name === humanaProjectID) {
    selectedProjectID = humanaProjectID;
  ...
  const baseSchema = {
    chart_uid: yup.string().required("File Name is required !"),
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      payload.file_name = payload.chart_uid;
  ...
  const cleanObject = (obj) => {
    ...
    Object.keys(obj).forEach((key) => {
      ...
      // Keep valid falsy values like 0 or false
      if (
        value !== undefined &&
        value !== null &&
        value !== "" &&
                  ...
                  <Offcanvas.Body>
                    <div>
                      ...
                      <div className="row mb-4 d-flex">
                        ...
                        <div className="col-6">
                          <p className="text-custom-color mb-0">Member ID</p>
                          <span className="text-data-color h6">
                            {chartDetails && chartDetails.member_id ? (
                              chartDetails.member_id
                            ) : (
                              <span className="text-muted">NA</span>
                            )}
                          </span>
