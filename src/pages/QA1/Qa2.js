...
const Qa2 = ({ module, from }) => {
  ...
  const getQA2 = async () => {
    try {
      ...
      const response = await apiClient.get(`quality-analyses/qa2`, {
        params: { ...params },
      });
  ...
  const mutation = useMutation({
    mutationFn: (values) =>
      apiClient.post(`quality-analyses/import/qa2`, values, {
        componentName: "addQA2",
      }),
  });
  ...
  const sampleTemplate = async () => {
    try {
      const response = await apiClient.get(`quality-analyses/qa2-template`, {
        responseType: "blob",
      });
  ...
  const handleStore = async () => {
    try {
      ...
      queryClient.invalidateQueries(["getQA2"]);
  ...
  return (
    <div className="container-fluid  overflow-y-auto">
      ...
      >
        <Tab eventKey="Qa2Dashboard" title="Qa2 Dashboard">
          QA2 Dashboard
        </Tab>
        <Tab eventKey="AddQuality2" title="AddQuality 2">
        ...
        <Tab eventKey="QA2Audits" title="QA2 Audits">
            ...
            <div className="tableparent">
              ...
              <div className="qaaudit-body px-3 pb-3">
                <ReactTable
                  data={data}
                  columns={tableColumns}
                  apiEndPoint={"quality-analyses/qa2"}
                  queryKey={"getQA2"}
                  search={search}
                  setSearch={setSearch}
                  page={page}
